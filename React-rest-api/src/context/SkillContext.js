...
export const SkillProvider = ({ children }) => {
    ...
    return <SkillContext.Provider value={{ skill, skills, getSkills, getSkill, onChange, formValues, storeSkill, errors, setErrors, updateSkill, deleteSkill }}>{children}</SkillContext.Provider>
}
